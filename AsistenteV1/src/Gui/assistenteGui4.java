...
public class assistenteGui4 {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					assistenteGui4 window = new assistenteGui4();
	...
	private class eventosTimer extends TimerTask {                                     //Clase Timer
	    public void run() {	
			...
			if (nombreUsuarioActivo.getText() != "") {
				if(usuarioActual.agenda.size() > 0) {
					...
					Instant instantFechaHoraActualMas = instantFechaHoraActual.plus(Duration.ofMinutes(20));
				
					Evento eventoAgenda = (Evento) usuarioActual.agenda.get(0);					
