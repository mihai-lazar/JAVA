...
/**
 *  Two-player Graphics version with Simple-OO
 */

@SuppressWarnings("serial")

public class GatoGrpahics extends JFrame {
   ...
   public static void main(String[] args) {
      ...
      SwingUtilities.invokeLater(
         ...
         @Override
         public void run() {
            new GatoGrpahics(); // Let the constructor do the job
         }
      }
      );
   }
