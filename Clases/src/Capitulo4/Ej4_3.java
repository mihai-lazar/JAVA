...
public class Ej4_3 
{
	public static void printAmerican(String dia, String mes, int diaNumero, int año)
	{
		System.out.println(dia + ", " + mes + " " + diaNumero + ", " + "20" + año);
	}
	
	public static void printEuropean(String dia, String mes, int diaNumero, int año)
	{
		System.out.println(dia + " " + diaNumero + " " + mes + " 20" + año);
	}
	...
	public static void main(String[] args) 
	{
		...
		{
			printAmerican(NombreDia, Meses[Mes-1], Dia, Año);
		}else if(EleccionFormato == 2) 
		{
			printEuropean(NombreDia, Meses[Mes-1], Dia, Año);
		}
